...
1. Simply restate what the code does (e.g. "Verify Metal branch", "Check root", "Verify children")
2. Are redundant with the code (e.g. "Get the metal genre" when the code is `metal = genres.get(name="Metal")`)
