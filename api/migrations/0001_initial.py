...
import api.model.utils.utils
import api.validator.TrackFileValidator
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lib_path_relative_to_media', models.GeneratedField(db_persist=True, expression=api.model.utils.ConditionalExpression.ConditionalExpression(condition_field='is_test_user', output_field=api.model.field.AppCharField(max_length=256), when_false=api.model.utils.ConcatOp.ConcatOp(models.Value('libraries'), models.Value('/'), models.Value('user_'), models.F('id')), when_true=api.model.utils.ConcatOp.ConcatOp(models.Value('libraries'), models.Value('/'), models.Value('test_user_'), models.F('id'))), output_field=api.model.field.AppCharField(max_length=256))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('code', models.PositiveIntegerField(choices=[(0, 'Audio Meta Amalysis Disabled'), (1, 'Track File Fingerprinting Failed'), (2, 'Duration Below Or Equal 1 Sec'), (3, 'Lookup Found No Matching Recording'), (4, 'Lookup Failed Due To Invalid Fingerprint'), (5, 'Lookup Failed With Internal Error'), (6, 'Lookup Failed With Unknown Response Error Code'), (7, 'Lookup Failed With Unknown Response Status Code'), (8, 'Lookup Failed Dns Resolution Error')], primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotify_library_last_synced_at', models.DateTimeField(blank=True, help_text="Timestamp of when the user's Spotify library was last synced", null=True)),
                ('spotify_sync_in_progress', models.BooleanField(default=False, help_text='Indicates if a Spotify library sync is currently in progress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('musicbrainz_link', models.GeneratedField(db_persist=True, expression=api.model.utils.ConcatOp.ConcatOp(models.Value('https://musicbrainz.org/artist/'), models.F('musicbrainz_id')), output_field=api.model.field.AppCharField(max_length=70))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(null=True)),
                ('musicbrainz_id', api.model.field.AppCharField(max_length=36, unique=True)),
                ('musicbrainz_link', models.GeneratedField(db_persist=True, expression=api.model.utils.ConcatOp.ConcatOp(models.Value('https://musicbrainz.org/recording/'), models.F('musicbrainz_id')), output_field=api.model.field.AppCharField(max_length=70))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', api.model.field.foreign_key.AppForeignKey.AppForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Play',
        ...
        migrations.CreateModel(
            name='SpotifyArtist',
            fields=[
                ('spotify_id', api.model.field.AppCharField(max_length=50, primary_key=True, serialize=False, unique=True)),
                ('name', api.model.field.AppCharField(editable=False, max_length=256)),
                ('popularity', models.IntegerField(editable=False, null=True)),
                ('spotify_link', models.GeneratedField(db_persist=True, expression=api.model.utils.ConcatOp.ConcatOp(models.Value('https://open.spotify.com/artist/'), models.F('spotify_id')), output_field=api.model.field.AppCharField(max_length=500))),
                ('genres', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), editable=False, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotify_link', models.GeneratedField(db_column='spotify_link', db_persist=True, expression=api.model.utils.ConcatOp.ConcatOp(models.Value('https://open.spotify.com/track/'), models.F('spotify_id')), output_field=api.model.field.AppCharField(max_length=500))),
                ('album', models.JSONField(db_column='album', editable=False, null=True)),
                ('preview_url', models.URLField(blank=True, db_column='preview_url', editable=False, max_length=512, null=True)),
                ...
                ('is_removed', models.BooleanField(db_column='is_removed', default=False, editable=False, help_text='Indicates if the track has been removed from Spotify')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('musicbrainz_recording', api.model.field.foreign_key.AppForeignKey.AppForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.mbrecording')),
        ...
        migrations.AddConstraint(
            model_name='artist',
            constraint=models.CheckConstraint(condition=models.Q(('_name', ''), _negated=True), name='artist_non_empty_name'),
        ),
        migrations.AddConstraint(
            model_name='album',
            constraint=models.CheckConstraint(condition=models.Q(('_name', ''), _negated=True), name='album_non_empty_name'),
        ),
        migrations.AddField(
            model_name='uploadedtrack',
            name='genre',
            field=api.model.field.foreign_key.PrivateForeignKey.PrivateForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='uploaded_tracks_of_criteria', to='api.genre'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='manualplaylist',
            constraint=models.CheckConstraint(condition=models.Q(('_name', ''), _negated=True), name='manual_playlist_non_empty_name'),
        ),
        migrations.AddIndex(
            model_name='playlist',
        ...
        migrations.AddConstraint(
            model_name='criteria',
            constraint=models.CheckConstraint(condition=models.Q(('_name', ''), _negated=True), name='criteria_non_empty_name'),
        ),
        migrations.AddConstraint(
            model_name='criteria',
