...
class AlbumTestCase(AppTestCase[Album]):
    ...
    def _post_album(self, **kwargs):
        return self.api_client.post(
            path=reverse('me-album-list'), data=kwargs, content_type='application/json', handle_response=self._set_results)
    ...
    def _put_album(self, uuid: UUID, **kwargs):
        return self.api_client.put(path=reverse('me-album-detail', kwargs={'pk': uuid}),
                                   data=kwargs,
