...
class TestCase(PlaylistTestCase):
    def test_retrieve_then_uploaded_track_ordered_by_created_on_desc(self):
        ...
        assert (
            result_tracks_sorted[1][uploaded_track_field_name][UploadedTrackOutputFieldKey.TITLE.value]
            == uploaded_track2.title
        )
        assert (
            result_tracks_sorted[2][uploaded_track_field_name][UploadedTrackOutputFieldKey.TITLE.value]
            == uploaded_track3.title
        )
