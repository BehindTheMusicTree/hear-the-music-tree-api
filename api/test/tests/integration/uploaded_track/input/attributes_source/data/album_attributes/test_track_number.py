...
class TestCase(UploadedTrackTestCase):
    ...
    def test_value_then_ok(self):
        value = 1
        data = {UploadedTrackInputFieldKey.ALBUM_NAME.value: 'albumito',
    ...
    def test_not_provided_then_none(self):
        data = {UploadedTrackInputFieldKey.ALBUM_NAME.value: "albumito", UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART.value: []}
        response = self._post_uploaded_track(UploadedTrackTestFilename.METADATA_NONE_MP3, **data)
