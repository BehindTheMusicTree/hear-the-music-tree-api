...
class TestCase(UploadedTrackTestCase, PutBodyDataTestCase):
    ...
    def test_empty_then_none(self):
        ...
        response = self._put_uploaded_track(uuid=uploaded_track.uuid, **{PutFields.ARTISTS_NAMES_MULTIPART: []})
    ...
    def test_provided_then_update(self):
        ...
        data = {PutFields.ARTISTS_NAMES_MULTIPART: [artist_new.name]}
    ...
    def test_two_artists_then_update(self):
        ...
        data = {PutFields.ARTISTS_NAMES_MULTIPART: [artist_new_1.name, artist_new_2.name]}
        response = self._put_uploaded_track(uuid=uploaded_track.uuid, **data)
    ...
    def test_delete_old_one_because_nothing_linked_to_it(self):
        ...
        data = {PutFields.ARTISTS_NAMES_MULTIPART: ["Other artist"]}
    ...
    def test_not_delete_old_one_because_a_track_linked_to_it(self):
        ...
        response = self._put_uploaded_track(uuid=track.uuid, **{PutFields.ARTISTS_NAMES_MULTIPART: [artist_name]})
        assert response.status_code == status.HTTP_200_OK
