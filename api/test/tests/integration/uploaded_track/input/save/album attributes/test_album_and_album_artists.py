...
class TestCase(UploadedTrackTestCase):
    def test_album_provided_but_album_artists_not_then_201_created(self):
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: "Koko"}
    ...
    def test_album_artists_provided_but_album_not_then_400_bad_request(self):
        data = {UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: ["Koko"]}
        response = self._post_uploaded_track(
            title="time", test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
    ...
    def test_album_artists_provided_but_album_empty_then_400_bad_request(self):
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: "", UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: ["Koko"]}
        response = self._post_uploaded_track(
    ...
    def test_provided_with_existing_album_with_album_artists_then_link_to_it(self):
        ...
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: album.name, UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: [album_artist1.name]}
        response = self._post_uploaded_track(
            test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
    ...
    def test_provided_with_existing_album_without_album_artists_then_link_to_it(self):
        ...
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: album.name, UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: []}
        response = self._post_uploaded_track(
            test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
    ...
    def test_provided_with_new_album_name_then_create_it(self):
        ...
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: "koko", UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: [album_artist_new.name]}
        response = self._post_uploaded_track(
            test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
    ...
    def test_provided_with_existing_album_artist_then_link_to_it(self):
        ...
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: album.name, UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: [album_artist.name]}
        response = self._post_uploaded_track(
            test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
    ...
    def test_provided_with_new_album_artist_name_then_create_it(self):
        ...
        data = {UploadedTrackInputFieldKey.ALBUM_NAME: album_new.name, UploadedTrackInputFieldKey.ALBUM_ARTISTS_NAMES_MULTIPART: ["James"]}
        response = self._post_uploaded_track(
            test_uploaded_track_filename=UploadedTrackTestFilename.SIZE_SMALL_0_01MO_MP3, **data)
