...
class TestCase(UploadedTrackTestCase, NullablePositiveIntBodyDataTestCase):
    ...
    def test_zero(self):
        rating = 0
        response = self._post_uploaded_track(UploadedTrackTestFilename.METADATA_NONE_MP3, **{PostFields.RATING: rating})
    ...
    def test_too_large_then_400_bad_request(self):
        response = self._post_uploaded_track(UploadedTrackTestFilename.METADATA_NONE_MP3, **{PostFields.RATING: 11})
    ...
    def test_multi_value_then_400_bad_request(self):
        response = self._post_uploaded_track(UploadedTrackTestFilename.METADATA_NONE_MP3, **{PostFields.RATING: [1, 2]})
    ...
    def test_string_not_castable_then_400_bad_request(self):
        response = self._post_uploaded_track(UploadedTrackTestFilename.METADATA_NONE_MP3, **{PostFields.RATING: 'five'})
