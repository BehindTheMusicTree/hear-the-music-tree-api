    ...
    def _post_uploaded_track(self, file_has_metadata: bool, extension: str, **data):
        if file_has_metadata:
            return super()._post_uploaded_track(
                self.file_extension_metadata_max_a_test_uploaded_track_mapping[extension], **data
            )
        return super()._post_uploaded_track(
            self.file_extension_metadata_none_test_uploaded_track_mapping[extension], **data
        )
