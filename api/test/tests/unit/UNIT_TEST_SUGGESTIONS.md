...
**Test file:** `api/test/tests/unit/utils/json_utils/test_json_utils.py`
...
**Test file:** `api/test/tests/unit/utils/model/test_model_utils.py`
...
**Test file:** `api/test/tests/unit/utils/test_utils.py`
...
**Test file:** `api/test/tests/unit/utils/env_var_loader/test_env_var_loader.py`
...
**Test file:** `api/test/tests/unit/utils/data_transformer/test_data_transformer.py`
...
**Test file:** `api/test/tests/unit/utils/jwt/test_jwt.py`
...
**Test file:** `api/test/tests/unit/utils/audio_fingerprinter/test_fingerprinter_utils.py`
**Test file:** `api/test/tests/unit/utils/audio_fingerprinter/test_fingerprinter_service.py`
...
**Test file:** `api/test/tests/unit/utils/audio_file_metadata/test_flac_md5.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_app_email_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_app_url_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_app_uuid_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_app_file_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_app_dict_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/foreign_key/test_private_uuid_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/foreign_key/test_non_self_referencing_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/foreign_key/test_descendant_aware_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/foreign_key/test_user_content_object_uuid_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/foreign_key/test_trackable_play_count_uuid_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_rating_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_track_number_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_unique_per_user_name_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_artists_names_field.py`
...
**Test file:** `api/test/tests/unit/serializer/field/test_tree_field.py`
...
**Test file:** `api/test/tests/unit/serializer/test_put_serializer.py`
...
**Test file:** `api/test/tests/unit/validator/test_track_url_validator.py`
...
**Test file:** `api/test/tests/unit/middleware/test_camel_to_snake_middleware.py`
...
**Test file:** `api/test/tests/unit/middleware/test_duplicate_fields_middleware.py` (may already exist)
...
**Test file:** `api/test/tests/unit/middleware/test_client_empty_list_middleware.py`
...
**Test file:** `api/test/tests/unit/middleware/test_host_validation_middleware.py`
...
**Test file:** `api/test/tests/unit/middleware/test_request_logging_middleware.py`
...
**Test file:** `api/test/tests/unit/middleware/test_exception_logging_middleware.py`
...
**Test file:** `api/test/tests/unit/exception/test_app_validation_exception.py`
...
**Test file:** `api/test/tests/unit/exception/spotify/test_spotify_exceptions.py`
...
**Test file:** `api/test/tests/unit/exception/musicbrainz/test_musicbrainz_exceptions.py`

---

## Test Organization

All new unit tests should be placed in `api/test/tests/unit/` following the existing directory structure:
