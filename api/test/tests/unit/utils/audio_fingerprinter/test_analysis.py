...
from api.utils.audio_fingerprinter.service import (
...
from api.utils.audio_fingerprinter.utils import exception as audio_fingerprinter_exc
...
class TestGetFingerprintAndDurationForAnalysisSuccess:
    def test_post_fingerprint_returns_data_then_dict_with_fingerprint_and_duration(self):
        ...
        with (
            patch(
                "api.utils.file_path_utils.get_file_name_system",
