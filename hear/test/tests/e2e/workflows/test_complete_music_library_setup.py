...
from hear.serializer.model.playlist.children.manual.input.Fields import (
...
from hear.test.tests.integration.playlist.children.manual.ManualPlaylistTestCase import (
    ManualPlaylistTestCase,
)
from hear.test.tests.integration.search.SearchTestCase import SearchMixin
