...
from hear.serializer.model.criteria.input.Fields import Fields as CriteriaInputFields
...
class TestCase(GenreTestCase, ForeignKeyBodyDataTestCase):
    def test_multi_value_then_400_bad_request(self):
        response = self._post_genre(
            **{CriteriaInputFields.NAME_PUBLIC: "Punk", CriteriaInputFields.PARENT: ["value", "value2"]}
        )
    ...
    def test_existing_then_ok(self):
        ...
        response = self._post_genre(
            **{CriteriaInputFields.NAME_PUBLIC: "Punk", CriteriaInputFields.PARENT: genre_rock.uuid}
        )
    ...
    def test_non_existing_then_400_bad_request(self):
        ...
        response = self._post_genre(
            **{
                CriteriaInputFields.NAME_PUBLIC: "Punk",
