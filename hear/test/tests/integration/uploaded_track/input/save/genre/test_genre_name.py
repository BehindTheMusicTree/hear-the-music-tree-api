...
from hear.test.utils.field.body_data.type.NullableCharBodyDataTestCase import NullableCharBodyDataTestCase
...
class TestCase(NullableCharBodyDataTestCase, UploadedTrackTestCase):
    ...
    def test_multi_value_then_400_bad_request(self):
        response = self._post_uploaded_track(
            UploadedTrackTestFilename.METADATA_NONE_MP3, **{UploadedTrackInputFieldKey.GENRE.value: ["a", "b"]}
        )
