...
from hear.test.utils.field.body_data.type.ForeignKeyBodyDataTestCase import ForeignKeyBodyDataTestCase
...
class TestCase(ForeignKeyBodyDataTestCase, UploadedTrackTestCase):
    def test_non_existing_then_400_bad_request(self):
        ...
        response = self._post_uploaded_track(
            UploadedTrackTestFilename.METADATA_NONE_MP3, **{UploadedTrackInputFieldKey.GENRE.value: non_exisintg_uuid}
        )
    ...
    def test_existing_then_ok(self):
        ...
        response = self._post_uploaded_track(
            UploadedTrackTestFilename.METADATA_NONE_MP3, **{UploadedTrackInputFieldKey.GENRE.value: genre.uuid}
        )
    ...
    def test_multi_value_then_400_bad_request(self):
        ...
        response = self._post_uploaded_track(
            ...
            **{UploadedTrackInputFieldKey.GENRE.value: [genre.uuid, genre.uuid]},
        )
    ...
    def test_invalid_uuid_then_400_bad_request(self):
        ...
        response = self._post_uploaded_track(
            UploadedTrackTestFilename.METADATA_NONE_MP3, **{UploadedTrackInputFieldKey.GENRE.value: invalid_uuid}
        )
