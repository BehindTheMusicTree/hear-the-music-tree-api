...
from hear.utils.google_oauth.oauth import GoogleOAuthService


class TestGoogleOAuthAuth(AppTestCase):
    @mock.patch("hear.utils.google_oauth.oauth.requests.post")
    ...
    @mock.patch("hear.utils.google_oauth.oauth.requests.post")
    def test_exchange_code_with_unauthorized_client_then_raises_with_unauthorized_client_detail_code(self, mock_post):
        mock_response = mock.Mock()
    ...
    @mock.patch("hear.utils.google_oauth.oauth.requests.get")
