...
from hear.exception.spotify import SpotifyAuthenticationException
from hear.model.user.spotify.Fields import Fields
from hear.model.user.User import User
from hear.test.utils.AppTestCase import AppTestCase
from hear.utils.spotify_api.oauth import SpotifyOAuthService
...
class TestSpotifyProfile(AppTestCase):
    def setUp(self):
        ...
        self.test_user1 = User(
            username="spotify_user1", email="spotify@user1.com", spotify_id="spotify_user1_id", is_test_user=True
        )
        self.test_user1.set_password("spotify_user1")
        self.test_user1.save()
        self.test_user2 = User(
            username="spotify_user2", email="spotify@user2.com", spotify_id="spotify_user2_id", is_test_user=True
        )
        self.test_user2.set_password("spotify_user2")
        self.test_user2.save()
        self._login_as_test_user1()

    @mock.patch("hear.utils.spotify_api.oauth.spotipy.Spotify")
    ...
    def test_get_user_info_with_minimal_profile_then_returns_basic_fields(self, mock_spotify):
        mock_spotify.return_value.current_user.return_value = {Fields.ID: "test_user", Fields.DISPLAY_NAME: "Test User"}
