...
import hear.serializer as serializer_package
...
class TestModelSerializerInheritance(AppTestCase):
    ...
    def _discover_model_serializer_classes(self):
        """
        Discover all model serializer classes in the hear.serializer package.
        ...
        for _importer, modname, ispkg in pkgutil.walk_packages(path=serializer_package_path, prefix="hear.serializer."):
