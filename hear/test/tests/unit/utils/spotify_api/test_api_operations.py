...
from hear.exception.spotify import SpotifyNetworkException, SpotifyResourceNotFoundException
...
from hear.utils.spotify_api.ApiFields import ApiFields
from hear.utils.spotify_api.managers.SpotifyApiLibTrackManager import SpotifyApiLibTrackManager
from hear.utils.spotify_api.SpotifyClient import SpotifyClient
...
class TestSpotifyAPIOperations(AppTestCase):
    def setUp(self):
        ...
        mock_cred = mock.patch("hear.utils.spotify_api.SpotifyClient.SpotifyCredentialManager")
        self.mock_cred_patcher = mock_cred.start()
        self.addCleanup(mock_cred.stop)
        cred_instance = self.mock_cred_patcher.return_value
        cred_instance.validate_credentials.return_value = None
        cred_instance.get_client_credentials.return_value = {
            "client_id": "test_id",
        ...
        self.mock_spotify_instance.search.return_value = {
            ApiFields.Names.TRACKS: {
                ApiFields.Names.ITEMS: [
                    {ApiFields.Names.ID: "track123", ApiFields.Names.NAME: "Test Track", ApiFields.Names.POPULARITY: 85}
                ]
            }
        }
        self.mock_spotify_instance.current_user_saved_tracks.return_value = {
            ApiFields.Names.ITEMS: [
                {ApiFields.Names.TRACK: {ApiFields.Names.ID: "track123", ApiFields.Names.NAME: "Test Track"}}
            ]
        }
        self.mock_spotify_instance.current_user_playlists.return_value = {
            ApiFields.Names.ITEMS: [{ApiFields.Names.ID: "playlist123", ApiFields.Names.NAME: "Test Playlist"}]
        }
    ...
    def test_search_track_with_valid_query_then_returns_results(self):
        ...
        mock_track = {
            ...
            ApiFields.Names.ARTISTS: [{ApiFields.Names.ID: "artist123", ApiFields.Names.NAME: "Test Artist"}],
        ...
        mock_search_result = {ApiFields.Names.TRACKS: {ApiFields.Names.ITEMS: [mock_track]}}
    ...
    def test_search_track_with_api_error_then_raises_spotify_api_exception(self):
        ...
        from hear.exception.spotify import SpotifyException
    ...
    def test_retrieve_track_by_isrc_with_valid_isrc_then_returns_track(self):
        ...
        with mock.patch(
            "hear.utils.spotify_api.managers.SpotifyApiLibTrackManager.get_spotify_client",
    ...
    @mock.patch("hear.utils.spotify_api.utils.create_spotify_lib_track_instance_from_dict")
    def test_search_spotify_lib_tracks_with_valid_query_then_creates_track_models(self, mock_create_track):
        mock_track_data = {ApiFields.Names.ID: "track123", ApiFields.Names.NAME: "Test Track"}
        mock_search_result = {ApiFields.Names.TRACKS: {ApiFields.Names.ITEMS: [mock_track_data]}}
    ...
    @mock.patch("hear.utils.spotify_api.utils.create_spotify_lib_track_instance_from_dict")
    @mock.patch("hear.model.spotify_resource.children.track.SpotifyLibTrack.SpotifyLibTrack.objects.get")
    ...
    @mock.patch("hear.utils.spotify_api.utils.create_spotify_lib_track_instance_from_dict")
    @mock.patch("hear.utils.spotify_api.managers.SpotifyApiLibTrackManager.get_spotify_client")
