...
from hear.exception.spotify import SpotifyAPIException
...
class TestClientCredentialsAuth(AppTestCase):
    @mock.patch("hear.utils.spotify_api.SpotifyClient.SpotifyCredentialManager")
    ...
    def test_authenticate_with_empty_credentials_then_raises_exception(self, mock_spotify, mock_cred_manager_class):
        ...
        mock_instance.validate_credentials.side_effect = SpotifyAPIException(
