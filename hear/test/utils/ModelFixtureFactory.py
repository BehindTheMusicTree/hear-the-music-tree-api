...
from hear.model.musicbrainz_resource.children.recording.MbRecording import Fields as MusicbrainzRecordingFields
from hear.model.musicbrainz_resource.children.recording.MbRecording import MbRecording
from hear.model.play.Fields import Fields as PlayFields
...
class ModelFixtureFactory:
    ...
    def create_uploaded_track_with_file(
        ...
        **kwargs,
        ...
        track_file_path_in_lib = user.lib_abs_path / os.path.basename(filename_str)
        try:
