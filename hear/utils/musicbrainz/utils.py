...
from hear.model.musicbrainz_resource.children.artist.Fields import Fields as MusicbrainzArtistFields
from hear.model.musicbrainz_resource.children.artist.MbArtist import MbArtist
from hear.model.musicbrainz_resource.children.recording.Fields import Fields as MusicbrainzRecordingFields
...
def _prepare_musicbrainz_recording_data(musicbrainz_recording_dict: dict) -> tuple[list[MbArtist], dict]:
...
def create_or_update_musicbrainz_recording_instance_from_dict(
    ...
    if not created:
        ...
        musicbrainz_recording.save(update_fields=list(update_fields.keys()))
    musicbrainz_recording.musicbrainz_artists.set(musicbrainz_artists)
    return musicbrainz_recording
